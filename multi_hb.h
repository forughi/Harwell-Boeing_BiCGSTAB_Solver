...
void r4mat_print ( int m, int n, double a[], string title )
...
void r4mat_print_some ( int m, int n, double a[], int ilo, int jlo, int ihi, 
...
void r4vec_print ( int n, double a[], string title )
...
void r4vec_print_part ( int n, double a[], int max_print, string title )
